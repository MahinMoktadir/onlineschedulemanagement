...
<form action="generateteacher.php" method="post">
                ...
                \ <td style=\"text-align:center\">TEA BREAK</td>
                 <td style=\"text-align:center\">{$row['period4']}</td>
                  ...
                  <td style=\"text-align:center\">{$row['period6']}</td>
                    ...
                    echo "<div style='margin-left: 10px' align='margin-left'>" . "<br>" . $str . "<br></div>" .
                        "<div style='margin-left: 10px' align='margin-left'>" . "<strong>" . $sign . "<br></strong></div>";
                }
                if (isset($_POST['select_teacher'])) {
