    ...
    <div class="container">
        ...
        <div class="navbar-collapse collapse move-me">
            <ul class="nav navbar-nav navbar-left">
                <li><a href="option3.php">Home</a></li>
        ...
        <div class="modal-body" id="EnterTeacher">
            ...
            <div style="display:none" id="addTeacherForm">
                <form action="addteacherFormValidation.php" method="POST">
                    ...
                    <div class="form-group">
                        <label for="TF">Faculty Name</label>
                        <input type="text" class="form-control" id="facultyname" name="TF" placeholder="Faculty Name ...">
                    </div>
                    <div class="form-group">
                        <label for="TF">Shortname</label>
                        <input type="text" class="form-control" id="Short_name" name="AL" placeholder="Shortname..">
                    </div>
                    <div class="form-group">
                        ...
                        <select class="form-control" id="designation" name="TD">
                            ...
                            <option value="Guest Faculty">Adjunct Faculty</option>
                        </select>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="teacheremailid">Email Address</label>
