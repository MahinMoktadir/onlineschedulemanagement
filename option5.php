...
<body>
    <div id="content">
        ...
        <div id="routine-buttons">
            ...
            <a href="allotclasses.php" class="custom-button">
                <img src="d:\Projects\Website\edit-interface-symbol-of-a-pencil-on-a-square-outline-paper.png"
                    alt="allot classes">
                    Allot-Classes
            </a>
            <a href="allotsubjects.php" class="custom-button" onclick="showRoutine()">
                <img src="d:\Projects\Website\10613736_10172.jpg" alt="allot Subjects">
                Allot-Subjects
            </a>
            <a href="allotpracticals.php" class="custom-button" onclick="searchRoutine()">
                <img src="d:\Projects\Website\magnifying-glass.png" alt="allot practicals">
                Allot-Practicals
            </a>
        </div>
    </div>
