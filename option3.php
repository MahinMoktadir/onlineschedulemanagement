...
<body>
    <div id="content">
        ...
        <div id="routine-buttons">
            ...
            <a href="addteachers.php" class="custom-button">
                <img src="d:\Projects\Website\edit-interface-symbol-of-a-pencil-on-a-square-outline-paper.png"
                    alt="add teacher">
                    Add Teachers
                
            </a>
            <a href="addsubjects.php" class="custom-button" onclick="showRoutine()">
                <img src="d:\Projects\Website\10613736_10172.jpg" alt="add Subjects">
                Add Subjects
            </a>
            <a href="addclassrooms.php" class="custom-button" onclick="searchRoutine()">
                <img src="d:\Projects\Website\magnifying-glass.png" alt="addclassrooms">
               Add Classrooms
            </a>
            <a href="option5.php" class="custom-button" onclick="searchTeacherSchedule()">
